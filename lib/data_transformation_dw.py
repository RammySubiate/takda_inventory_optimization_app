...
def build_item_procurement_lead_time(
    ...
    - Filter PO headers to include:
        - Active released POs (status == "Released")
    ...
    for item in item_list:
        ...
        df_pr_header_active_released = df_pr_header_item[df_pr_header_item["status"] == "Released"]
        ...
        df_po_in_header_archive_only = df_po_in_header_archive_only[["po_no", "pr_no", "order_date"]]
         ...
         # Active released POs
        df_po_in_header_active_released = df_purchase_header_item[df_purchase_header_item["status"] == "Released"] 
